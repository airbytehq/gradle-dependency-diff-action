...
export declare function calculateDiffResults(jarPath: string, configuration: string, oldRepoDir: string, newRepoDir: string, tempDirs: TempDirs): Promise<DiffResult[]>;
